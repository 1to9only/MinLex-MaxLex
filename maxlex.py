...
this_program = "maxlex.py"
this_version = "1.00"
import os, sys, optparse

# source attribution:
#
# maxlex.py is my modifications to canonical.py to calculate MAXimal LEXicographical sudoku grids
#
...
#
# I have modified (a lot!) and reformatted maxlex.py code to my liking!!
#
# Usage: maxlex.py [puzzle string|puzzles file]
#
# Examples:
# maxlex.py 000000075000080094000500600010000200000900057006003040001000023080000006063240000
# maxlex.py 8..........36......7..9.2...5...7.......457.....1...3...1....68..85...1..9....4..
# maxlex.py 812753649943682175675491283154237896369845721287169534521974368438526917796318452
# maxlex.py puzzles.txt
#
# Results:
# 98.76.5..76.9..43...3..5....2......6..78....5....4........3.1.4.....1.23.........
# 98.7.....7..8..6....5.4....3.....7....2....65....6..2...1.2...4...3..9.......8...
